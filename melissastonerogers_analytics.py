...
This project will fetch data from the web, process
in Python, and write the processed data to files.
'''
...
# Function to read data from Excel file (.xls format)
...
# Function to fetch data to new Excel file
def fetch_and_write_excel_data(excel_folder_name, excel_filename, excel_url):
    ...
    if response.status_code == 200:
        ...
        # Write binary data to Excel file
...
# Function to fetch data to new csv file
...
# Function to fetch data to new json file
...
def main():
    ...
    # Print my name
    name = "Melissa Stone Rogers"
    print(f"Name: {name}")

    # Main url's
    txt_url = 'https://www.gutenberg.org/files/1513/1513-h/1513-h.htm'
